        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanguageName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 3, 5, 22, 31, 15, 245, DateTimeKind.Local).AddTicks(7955)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("6a768150-5de9-48d0-97df-9d1542314334"), "93a3b6f2-743b-45fa-985c-a1d30c29909c", "Adminstrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("bab47f6a-ca90-4fc2-a18d-484060a1332b"), 0, new DateTime(1999, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "0e88ab3b-35ef-4a27-9d0e-a6138406cf5c", "nguyengiahuunghia118@gmail.com", true, "Nghia", "Gia", false, null, "nguyengiahuunghia118@gmail.com", "admin", "AQAAAAEAACcQAAAAEACtSSSzxQGV9tHn/P5romG0g5MRrKBhmAaMXXiaeAI4+ti9eVv6FF1QxBrTlBXCpQ==", null, false, null, false, "admin" });
            ...
            migrationBuilder.InsertData(
                table: "Languages",
                columns: new[] { "Id", "IsDefault", "LanguageName" },
                values: new object[] { "vi", true, "Tiếng Việt" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CategoryId", "CategoryName", "LanguageId", "SeoAlias", "SeoDescription", "SeoTitle" },
                values: new object[,]
                {
                    { 1, 1, "Văn Học", "vi", "van-hoc", "Sách thể loại văn học", "Sách văn học" },
                    { 2, 1, "Literary", "en", "literary", "literary", "Literary Book" },
                    { 3, 2, "Kinh Tế", "vi", "kinh-te", "Sách thuộc thể loại kinh tế", "Sách kinh tế" },
                    { 4, 2, "Economic", "en", "economic", "economic", "Economic Book" }
                });
