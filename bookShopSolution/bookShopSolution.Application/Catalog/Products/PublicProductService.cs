...
namespace bookShopSolution.Application.Catalog.Products
{
    public class PublicProductService : IPublicProductService
    {
        ...
        public PublicProductService(BookShopDbContext context)
        {
            _context = context;
        }

        public async Task<PagedResult<ProductViewModel>> GetAllByCategoryId(int languageId, GetPublicProductPagingRequest request)
        {
